...
########################################################################################################################
# Run NLP example on Spark x Docker compose on local machine.
########################################################################################################################

compose_yaml=$SPARK_ON_SWARM_DIR/Core/Docker/ComposeYAMLs/docker-compose.yml

py_script_name=nlp.py
py_script=$SPARK_ON_SWARM_DIR/Apps/SparkML/NLP/$py_script_name
dataset=$SPARK_ON_SWARM_DIR/Apps/SparkML/NLP/train.csv
