...
python_file=$SPARK_ON_SWARM_DIR/Apps/SparkML/LinearRegression/linear_regression.py
dataset_file=boston_housing.csv
dataset_filepath=$SPARK_ON_SWARM_DIR/Apps/SparkML/LinearRegression/$dataset_file
