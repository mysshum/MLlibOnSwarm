...
########################################################################################################################
# Runs random forest classifier on Spark x Docker compose on local machine
########################################################################################################################

compose_yaml=$SPARK_ON_SWARM_DIR/Core/Docker/ComposeYAMLs/docker-compose.yml

py_script_name=random_forest_classifier.py
py_script=$SPARK_ON_SWARM_DIR/Apps/SparkML/RandomForestClassifier/$py_script_name
dataset=$SPARK_ON_SWARM_DIR/Apps/SparkML/RandomForestClassifier/titanic.csv
