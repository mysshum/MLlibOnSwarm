...
python_file=$SPARK_ON_SWARM_DIR/Apps/SparkML/RandomForestClassifier/random_forest_classifier.py
dataset_file=titanic.csv
dataset_filepath=$SPARK_ON_SWARM_DIR/Apps/SparkML/RandomForestClassifier/$dataset_file
